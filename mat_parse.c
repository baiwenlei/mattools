...
{
       0,    56,    56,    65,    66,    67,    79,    99,   101,   102
};
#endif
...
{
  "$end", "error", "$undefined", "NL", "NUM", "$accept", "matrix",
  "blank_or_rows", "blank", "row", YY_NULL
};
#endif
...
/* Line 1787 of yacc.c  */
#line 99 "../mat_parse.y"
    {parser->blanknum++; fprintf(stdout, "[info] find blank line at line %d\n", parser->lineno);}
    break;

  case 8:
/* Line 1787 of yacc.c  */
#line 101 "../mat_parse.y"
    {vary_array_push(parser->ary, (yyvsp[(1) - (1)].value));}
    break;

  case 9:
/* Line 1787 of yacc.c  */
#line 102 "../mat_parse.y"
    {vary_array_push(parser->ary, (yyvsp[(2) - (2)].value));}
    break;


/* Line 1787 of yacc.c  */
#line 1460 "mat_parse.c"
      default: break;
    }
